...
-- Dumping database structure for myhospital-db
CREATE DATABASE IF NOT EXISTS `myhospital-db` /*!40100 DEFAULT CHARACTER SET utf8 */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `myhospital-db`;

-- Dumping structure for table myhospital-db.sys_department
...
-- Dumping structure for table myhospital-db.sys_department_user
...
-- Dumping structure for table myhospital-db.sys_dictionary
...
-- Dumping structure for table myhospital-db.sys_dictionary_item
...
-- Dumping structure for table myhospital-db.sys_message_content
...
-- Dumping structure for table myhospital-db.sys_message_receiver
...
-- Dumping structure for table myhospital-db.sys_message_sender
...
-- Dumping structure for table myhospital-db.sys_region
...
-- Dumping structure for table myhospital-db.sys_resource
...
-- Dumping structure for table myhospital-db.sys_role
...
-- Dumping structure for table myhospital-db.sys_role_resource
...
-- Dumping structure for table myhospital-db.sys_user
...
-- Dumping structure for table myhospital-db.sys_user_role
...
-- Dumping structure for table myhospital-db.tbl_hospital
CREATE TABLE IF NOT EXISTS `tbl_hospital` (
  ...
  `level` varchar(3) NOT NULL COMMENT '等级',
  `address` varchar(255) DEFAULT NULL COMMENT '地址',
  `postal_code` varchar(6) DEFAULT NULL COMMENT '邮编',
  `introduction` varchar(255) DEFAULT NULL COMMENT '简介',
  `lng` decimal(10,6) NOT NULL COMMENT '经度',
  `lat` decimal(10,6) NOT NULL COMMENT '纬度',
  `flag` char(1) NOT NULL DEFAULT '' COMMENT '医院标示，A，表示是A类定点医院',
  `create_time` datetime DEFAULT NULL COMMENT '创建时间',
  `update_time` datetime DEFAULT NULL COMMENT '修改时间',
  PRIMARY KEY (`id`),
  UNIQUE KEY `code` (`code`)
) ENGINE=InnoDB AUTO_INCREMENT=2940 DEFAULT CHARSET=utf8 COMMENT='社保定点医院表';
