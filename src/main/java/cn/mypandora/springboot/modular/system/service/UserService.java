...
public interface UserService {
     ...
     * 登出
     *
     * @param authorization 用户authorization
     */
     ...
     *
     * @param user               用户
     * @param plusDepartmentIds  新添加部门id数组
     * @param minusDepartmentIds 删除旧部门id数组
     */
     ...
     *
     * @param userId       用户Id
     * @param plusRoleIds  增加用色Id数组
     * @param minusRoleIds 删除用色Id数组
     */
